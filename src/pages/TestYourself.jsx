    ...
    <>
      ...
      {isLoading ? <LoadingSpinner /> :
        (questions.length ? <div className='mt-2'>
          ...
          {isModalOpen && <Modal setIsModalOpen={setIsModalOpen} answerReason={questions[currentQuestionIndex]?.answer_reason} />}
        </div> : <p className='text-center fs-2 fw-bold my-2'>لا أسئلة حتى الآن.</p>)}
    </>
  )
}
